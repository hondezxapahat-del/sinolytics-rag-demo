...
const I18N_DICT = {
  en: {
    ...
    ask_note_web_html: "<b>Note:</b> preliminary signal from a live web search — pending expert review, not a finalized Sinolume assessment.",
    ask_note_internal_prefix_html: "<b>Based on our prior analysis:</b> ",
    ask_internal_analysis_label: "Sinolume's prior analysis on this topic",
  ...
  zh: {
    ...
    ask_note_web_html: "<b>提示：</b>这是来自实时网络搜索的初步信号——尚待专家审核，并非 Sinolume 的最终结论。",
    ask_note_internal_prefix_html: "<b>基于我们此前的分析：</b>",
    ask_internal_analysis_label: "Sinolume 关于该话题的既有分析",
