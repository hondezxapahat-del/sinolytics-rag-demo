...
**Evaluation set construction**: hand-designed, covering both existing corpus topics (export controls, NEV price war), with roughly 10-20 representative questions per topic, spanning different difficulty levels/types: single-fact questions, multi-point synthesis questions, questions the corpus doesn't cover (where the correct answer is honestly "I don't know"), and cross-topic confusion tests.
